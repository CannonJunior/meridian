...
// Duplicated across kafka/producer*/src (same rationale as
// kafka/producer/src/produce.ts's AO_BOUNDS/destinationPoint comments) — no
// shared package exists between these independent, independently-built
// containers. Side-effecting: import this module (for the registration)
// before any producer.send(..., { compression: CompressionTypes.ZSTD }) call.
//
