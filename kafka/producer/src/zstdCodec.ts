...
// Duplicated across kafka/producer*/src the same way AO_BOUNDS/
// destinationPoint above are — this producer isn't part of the server/ or
// web/ TypeScript project, so there's no shared package to put it in once
// instead. Side-effecting: import this module (for the registration) before
// any producer.send(..., { compression: CompressionTypes.ZSTD }) call.
//
